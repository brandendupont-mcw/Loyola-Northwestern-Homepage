...
<section className="relative flex items-center justify-center overflow-hidden border-t-2 border-black ">
                <div className="relative items-center w-full px-5 py-12 mx-auto max-w-7xl lg:px-16 lg:py-24 md:px-12 ">
                  <div className="">
                    <div className="max-w-3xl mx-auto">
       
                      <p className="mt-6 text-4xl font-bold tracking-tight text-black md:text-6xl">
                        The First Statewide Prosecutor Data Initiative
                  ...
                  <div className="relative items-center w-full py-12 pb-12 mx-auto mt-12 max-w-7xl">
                    ...
                    <div className="min-h-[600px] w-[1152px] border-2 rounded shadow-xl bg-white border-black">
        ...
        <section className="mb-10">
                <div className="px-8 mx-auto md:px-12 lg:px-32 max-w-7xl ">
                  <div className="text-center">
                    ...
                    <dl className="grid grid-cols-1 gap-6 mt-12 lg:grid-cols-3 text-balance">
                      <div>
                      <div>
      <h5 className="leading-none text-3xl font-bold text-gray-900 dark:text-white pb-2">15</h5>
      <p className="text-base font-normal ">Released External Dashboards</p>
  </div>
                      </div>
                      <div>
                      <div>
      <h5 className="leading-none text-3xl font-bold text-gray-900 dark:text-white pb-2">8</h5>
      <p className="text-base font-normal ">Analyzed Racial and Ethnic Disparities in their office</p>
  </div>
                      </div>
                      <div>
                      <div>
      <h5 className="leading-none text-3xl font-bold text-gray-900 dark:text-white pb-2">15</h5>
      <p className="text-base font-normal ">Published External Data Stories in their Jurisdiction</p>
  </div>
                      </div>
                    </dl>
                  </div>
