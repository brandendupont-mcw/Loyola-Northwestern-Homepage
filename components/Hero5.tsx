...
<section className="relative flex items-center justify-center overflow-hidden bg-primary-500 ">
                <div className="relative items-center w-full px-5 py-12 mx-auto max-w-7xl lg:px-16 lg:py-16 md:px-12 ">
                  <div className="">
